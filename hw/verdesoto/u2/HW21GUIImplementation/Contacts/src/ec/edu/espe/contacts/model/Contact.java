...
public class Contact {
    ...
    public String toString() {
        return "Contact{" + "id=" + id + ", fullName=" + fullName + ", contactName=" + contactName + ", phoneNumber=" + phoneNumber + ", email=" + email + ", gender=" + gender + ", type=" + type + ", bornOnDate=" + bornOnDate + ", hobbies=" + hobbies + ", comments=" + comments + ", favoriteTeam=" + favoriteTeam + '}';
    }
