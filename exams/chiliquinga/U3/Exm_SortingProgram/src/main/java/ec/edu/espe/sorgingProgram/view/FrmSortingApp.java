...
public class FrmSortingApp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Sorting Program by Yeshua");
        ...
        btnSort.setBackground(new java.awt.Color(204, 153, 255));
        ...
        brnClean.setBackground(new java.awt.Color(204, 153, 255));
        brnClean.setForeground(new java.awt.Color(51, 51, 51));
    ...
    private void btnSortActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSortActionPerformed
        String input = txtEnterNumbers.getText();
        String[] numberInput = input.split(",");

        // Remove leading and trailing whitespaces
        for (int i = 0; i < numberInput.length; i++) {
            numberInput[i] = numberInput[i].trim();
        }

        if (numberInput.length < 2) {
            JOptionPane.showMessageDialog(null, "Enter at least two numbers to order.", "Error", JOptionPane.ERROR_MESSAGE);
            return; // Exit the method if there are not enough numbers to sort
        }

        int[] insertedData = new int[numberInput.length];
        for (int i = 0; i < numberInput.length; i++) {
            insertedData[i] = Integer.parseInt(numberInput[i]);
        }
