...
public class Utils {
    public static MongoDatabase connectToDatabase(String uri, String dataBase){
        MongoClient mongoClient = MongoClients.create("mongodb+srv://EdVerdesoto:edverdesoto@edverdesoto.nrtppkc.mongodb.net/?retryWrites=true&w=majority");
        MongoDatabase mongoDatabase = mongoClient.getDatabase("Actors");
    ...
    public static MongoCollection connectToCollection(MongoDatabase database, String collection){
        MongoCollection<Document> mongoCollection = database.getCollection("Actors");
