...
public class FrmContacts extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnType.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Nothing", "Student", "Profesor", "Machine" }));
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        contactName = cmbContact.getItemAt(id);
        phoneNumber = txtPhoneNumber.getText();
        email = txtEmail.getText();
        type = btnType.getToolTipText();
        //hobbies = listHobbies.getAccessibleContext();
        comments = jTextArea1.getText();
        String message = "ID: " + id + "\n" +
                 "Full Name: " + fullName + "\n" +
                 "Contact Number: " + contactName + "\n" +
                 "Cellphone: " + phoneNumber + "\n" +
                 "Email: " + email + "\n" +
                 "Type: " + type + "\n" +
                 "Comments: " + comments;
        int mess = JOptionPane.showConfirmDialog(null, message, "Do you really want to add:", JOptionPane.OK_CANCEL_OPTION);
