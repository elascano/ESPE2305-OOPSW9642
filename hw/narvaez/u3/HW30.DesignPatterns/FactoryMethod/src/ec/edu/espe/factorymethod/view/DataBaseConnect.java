...
public class DataBaseConnect extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("If you write MongoDB, it will show the message MongoDB, otherwise it will print MongoDBAtlas");
    ...
    private void operationActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_operationActionPerformed
        ...
        if (input.equalsIgnoreCase("MongoDB")) {
             JOptionPane.showMessageDialog(null, "You're connecting with: " + connection.description());
        }else {
            JOptionPane.showMessageDialog(null, "You're connecting with: "+ connection.description());
            }
