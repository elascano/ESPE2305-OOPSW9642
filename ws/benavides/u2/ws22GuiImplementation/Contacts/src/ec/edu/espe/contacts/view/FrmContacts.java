...
public class FrmContacts extends javax.swing.JFrame {
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        int option = JOptionPane.showConfirmDialog(this,"Do you want to add  --> \n" + contact.toString(), "saving warning",1);
        if(option == 0){
            JOptionPane.showMessageDialog(rootPane, "saved, saving..");
            //call to method to save in MongoDB
            clearFields();
        }
        if(option == 1){
    ...
    private void readData() throws NumberFormatException{
        ...
        String gender = "example text";
        String type = "example text";
