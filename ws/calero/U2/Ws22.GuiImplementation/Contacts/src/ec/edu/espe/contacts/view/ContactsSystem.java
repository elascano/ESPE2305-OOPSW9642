...
public class ContactsSystem extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        mnuItemGo = new javax.swing.JMenuItem();
        ...
        itmModify = new javax.swing.JCheckBoxMenuItem();
        ...
        mnuItemGo.setText("Go");
        mnuItemGo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                mnuItemGoActionPerformed(evt);
            }
        });
        mnuManagement.add(mnuItemGo);

        mnuContacts.add(mnuManagement);

        mnuContact.setText("Contacts");
        mnuContacts.add(mnuContact);

        mnuCall.setText("Call");

        jMenuItem1.setText("Phone");
        mnuCall.add(jMenuItem1);

        jMenuItem2.setText("Whatsapp");
        mnuCall.add(jMenuItem2);

        jMenuItem3.setText("Messenger");
        mnuCall.add(jMenuItem3);
    ...
    private void mnuItemGoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_mnuItemGoActionPerformed
        FrmContacts frmContacts = new FrmContacts();
        frmContacts.setVisible(true);
        this.setVisible(false);
    }//GEN-LAST:event_mnuItemGoActionPerformed
    ...
    private javax.swing.JCheckBoxMenuItem itmModify;
    ...
    private javax.swing.JMenuItem mnuItemGo;
